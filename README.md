...
Requires macOS 15 or later — universal binary (Apple Silicon + Intel). Tiler
targets macOS 26 and is verified on 26.5 (Apple Silicon); older versions can run
it, but are untested for now.
